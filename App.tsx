...
import { Page, AssetId, AssetValues, AssetConfig, CalculationResults } from './types';
import { ASSETS_CONFIG } from './constants';
import { calculateWealthTax, formatCurrency, formatNumber, parseNumber } from './services/calculatorService';
import { CalculatorPage } from './components/CalculatorPage';
import { PurchasingPowerPage } from './components/PurchasingPowerPage';
